...
const Home = ({ onSelectCategory }) => {
  ...
  return (
    <div className="container-fluid my-0 my-sm-5 py-0 py-sm-5">
      <div className="row d-flex flex-wrap">
        <div className='col-12 col-md-5 p-5 d-flex flex-column justify-content-center align-items-center align-items-sm-end'>
          <h3>Find your Product</h3>
          <p className='text-center text-sm-end'>We will guide you to find your current product and show you the best alternatives to improve your pool</p>
